...
# -*- coding: utf-8 -*-
"""
PRE-TRADE CHECKLIST - TOP 5 SETUPS (2026-01-25 SUNDAY)
=======================================================
Runs comprehensive 5-check analysis on today's Sunday Dashboard Top 5:
1. CALM - Score 100/100
2. KBH - Score 84.3/100
3. NEU - Score 73.2/100
4. NMAN.ST - Score 67.3/100
5. PI - Score 54.9/100

Author: V4.0 Position Trading System with Statistical Improvements
"""
...
# Top 5 Setups from Sunday Dashboard 2026-01-25
SETUPS = [
    {"ticker": "CALM", "score": 100.0, "position_sek": 3000, "expected_profit_sek": 181, "win_rate": 0.939, "ev_63d": 0.1153, "sample_size": 49},
    {"ticker": "KBH", "score": 84.3, "position_sek": 2000, "expected_profit_sek": 185, "win_rate": 0.618, "ev_63d": 0.1507, "sample_size": 55},
    {"ticker": "NEU", "score": 73.2, "position_sek": 3000, "expected_profit_sek": 215, "win_rate": 0.968, "ev_63d": 0.1181, "sample_size": 31},
    {"ticker": "NMAN.ST", "score": 67.3, "position_sek": 3000, "expected_profit_sek": 247, "win_rate": 0.917, "ev_63d": 0.1111, "sample_size": 39},
    {"ticker": "PI", "score": 54.9, "position_sek": 3000, "expected_profit_sek": 416, "win_rate": 0.871, "ev_63d": 0.3645, "sample_size": 31}
]
...
def check_2_cost_aware_filter(setup, costs):
    ...
    print(f"Gross EV (63d):   +{gross_ev_pct:.2f}%")
...
def run_pretrade_checks():
    ...
    print("="*80)
    print("PRE-TRADE CHECKLIST - TOP 5 SETUPS (2026-01-25 SUNDAY)")
    print("="*80)
    ...
    for i, setup in enumerate(SETUPS, 1):
        ...
        print(f"# Sample Size: n={setup['sample_size']} | Win Rate: {setup['win_rate']*100:.1f}%")
        print(f"{'#'*80}")
    ...
    print(f"{'Ticker':<10} {'Score':<8} {'n':<5} {'C1':<5} {'C2':<5} {'C3':<5} {'C4':<5} {'C5':<5} {'Decision':<10}")
    print(f"{'-'*80}")
    ...
    for r in results:
        ...
        print(f"{r['ticker']:<10} {r['score']:<8.1f} {r['sample_size']:<5} {c1:<5} {c2:<5} {c3:<5} {c4:<5} {c5:<5} {r['recommendation']:<10}")
